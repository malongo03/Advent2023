...
def find_lagoon_area(dig_instructions):
    ...
    # Follows dig instructions, storing the vertex tiles created by each
    ...
    # rather, the coordinate of the upper-left corner of each of the vertex
    # tiles. This distinction is important, and it's why we have to then use
    # Pick's theorem to correct the discrepancy.
    shoelace = 0
...
def solve_day_18(filename):
    """
    Parses the inputs for Day 17 of the Advent of Code 2023, splitting them into
